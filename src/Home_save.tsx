...
//       if (storedData) {
//         const { points: storedPoints} = JSON.parse(storedData);
...
//         try {
//           const response = await axios.put(`${BD_URL}/api/records/chat/${telegramId}/balance/adjust`, {
...
//               'Content-Type': 'application/json',
//               'Authorization': `Bearer ${SECRET_TOKEN}`,
//               // CORS заголовки обрабатываются на стороне сервера, убедитесь, что сервер настроен правильно
//             },
//             // Указываем с какими credentials можно работать
//             withCredentials: true  // Разрешает отправлять cookies при необходимости
//           });
...
//       try {
//         await axios.put(`${BD_URL}/api/records/chat/${telegramId}/balance/adjust`, {
//           amount: ~~(points / 1000) }, {
//           headers: {
//             'Content-Type': 'application/json',
//             'Authorization': `Bearer ${SECRET_TOKEN}`
