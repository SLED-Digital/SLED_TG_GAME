...
const Home = () => {
  ...
  <div className="absolute inset-0 h-1/2 bg-gradient-overlay z-0"></div>
      ...
      <div className="absolute bottom-0 w-full flex justify-center items-center pb-4">
        <div className="buttonvivod-button" onClick={handleWithdrawClick}><p>вывести</p></div>
      </div>
  ...
  <div className="w-full z-10 min-h-screen flex flex-col items-center text-white">
    ...
    <div className="fixed bottom-0 left-0 w-full px-4 pb-4 z-22 navigatblock">
